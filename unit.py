...
class UNITGAN:
    def __init__(self, training = True):
        ...
        if training:
            self.dataset = CycleGANDataset(base_dir = '/home/daniel/DL/Project/train/Yosemite')
        else:
            self.dataset = CycleGANDataset(base_dir = '/home/daniel/DL/Project/train/Yosemite', phase = 'test')
